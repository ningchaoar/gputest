...
#deepspeed --include localhost:7 inference-test.py --model ../ckpts/Llama-2-13B-fp16 --batch_size 1 --greedy --use_kernel --test_performance
#deepspeed --include localhost:0,1 inference-test.py --model ../ckpts/Llama-2-70B-fp16 --batch_size 1 --greedy --use_kernel --test_performance
